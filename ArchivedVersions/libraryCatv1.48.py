...
class MainWindow:
    def __init__(self,master):
        ...
        # Master Window
        self.master = master
        self.master.title('Library Cat V. 1.48')
    ...
    def getSearchTerms(self):
        ...
        print('Results from main program and sent to interface:', self.results)
        self.updateResults(self.results)
    # Important Task: if the item popped is None, the insert method comes to a grinding halt. Therefore all popped items need to be checked for None first.
