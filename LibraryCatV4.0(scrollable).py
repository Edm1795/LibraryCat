...
class LibItem:
    ...
    def getAuthor(self): # the author comes as a list with one item ['cooke, Tim']
...
class MainWindow:
    def __init__(self, master):
        ...
        self.master = master
        self.master.title('Library Cat V. 4.3')
    ...
    def updateResults(self, results):
        ...
        # List of item formats, once loop finds a match, it takes the second item of the tuple for display
        listOfFormats = [('BK', 'BOOK',self.frame1.scrollable_frame), ('DVD', 'DVD',self.frame2.scrollable_frame), ('CD', 'CD',self.frame3.scrollable_frame), ('GRAPHIC_NOVEL', 'GRAPHIC NOVEL',self.frame4.scrollable_frame)]
