...
class ScrollableFrame(Frame):
    def __init__(self, parent):
        ...
        self.canvas = Canvas(self, height=150)
        ...
        # --- GRID instead of PACK ---
        self.canvas.grid(row=0, column=0, sticky="nsew")
        self.scrollbar.grid(row=0, column=1, sticky="ns")

        # Mouse wheel only when hovering
...
class MainWindow:
    def __init__(self, master):
        ...
        frame3 = ScrollableFrame(self.master)
        frame3.grid(row=1, column=2, sticky="nsew", padx=10, pady=10)

        # Fourth frame of items
        frame4 = ScrollableFrame(self.master)
        frame4.grid(row=1, column=3, sticky="nsew", padx=10, pady=10)
        ...
        for instance in results:
            if instance.getFormat() == 'BK':
                ...
                if instance.getImage() == 0:
                    label = Label(self.scrollable_frame1, text=posting, anchor='w', justify='left',
