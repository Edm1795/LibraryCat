...
class MainWindow:
    def __init__(self, master):
        ...
        # Master Window
        self.master = master
        self.master.title('Library Cat V. 1.49')
    ...
    def getSearchTerms(self):
        ...
        self.results = programFlow(searchTerms,2)
...
def programFlow(searchTerms,numOfResultPages):
    ...
    numOfResultPages += 1 # increment number desired by one just to start
    c = 1
